<!DOCTYPE html>
<!-- saved from url=(0031)https://tparf.ru/admin/messages -->
<html lang="ru"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title>Сообщения</title>
    
        
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <link rel="preload" href="./messages_files/admin.min.css" as="style">
        <link rel="preload" href="./messages_files/admin.min.js" as="script">

        <link rel="stylesheet" href="./messages_files/admin.min.css">
    
<script src="./messages_files/dsp" type="text/javascript" defer="" async=""></script><script type="text/javascript" src="chrome-extension://epebfcehmdedogndhlcacafjaacknbcm/nmcades_plugin_api.js"></script></head>
...
<div class="d-flex flex-column wrapper">
        ...
        <div class="d-flex align-items-center btn-group admin">
            ...
            <div class="dropdown">
                ...
                <ul class="mt-1 border shadow-lg dropdown-menu dropdown-menu-right admin-menu">
                    <li>
                        <a href="https://tparf.ru/admin/cabinet" class="d-flex align-items-center p-2 link">
        ...
        <div data-scrollbar="" class="py-2 overflow-y flex-fill-auto sidebar-body mCustomScrollbar _mCS_1 mCS_no_scrollbar"><div id="mCSB_1" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" style="max-height: none;" tabindex="0"><div id="mCSB_1_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
            ...
            <nav class="sidebar-menu">
                <ul class="nav sidebar-menu-nav">
                    <li class="w-100">
                        <a href="https://tparf.ru/admin" class="d-flex align-items-center py-2 px-3 link">
                    ...
                    <li class="w-100">
                        <a href="https://tparf.ru/" class="d-flex align-items-center py-2 px-3 link">
                    ...
                    <li class="w-100">
                        <a href="https://tparf.ru/admin/orders" class="d-flex align-items-center py-2 px-3 link">
                    ...
                    <li class="w-100">
                        <a href="https://tparf.ru/admin/ordersHistory" class="d-flex align-items-center py-2 px-3 link">
                    ...
                    <li class="w-100">
                        <a href="https://tparf.ru/admin/products" class="d-flex align-items-center py-2 px-3 link">
                    ...
                    <li class="w-100">
                        <a href="https://tparf.ru/admin/prices" class="d-flex align-items-center py-2 px-3 link">
                    ...
                    <li class="w-100">
                        <a href="https://tparf.ru/admin/categories" class="d-flex align-items-center py-2 px-3 link">
                    ...
                    <li class="w-100">
                        <a href="https://tparf.ru/admin/messages" class="d-flex align-items-center py-2 px-3 link active">
                    ...
                    <li class="w-100">
                        <a href="https://tparf.ru/admin/company" class="d-flex align-items-center py-2 px-3 link">
    ...
    <div class="d-flex flex-column p-3 page">
        <div id="messenger" class="h-100 overflow-hidden rounded d-flex shadow-sm bg-white position-relative messenger">
            <!-- users -->
            <div data-contacts="" class="d-flex flex-column border-right bg-white messenger-contacts">
                <div class="d-flex d-md-none align-items-center border-bottom p-2 pl-3">
                    <div class="h5 m-0">Контакты</div>
                    <button data-contacts-btn="" type="button" class="btn shadow-none text-secondary p-0 ml-auto">
                        <svg class="icon" viewBox="0 0 50 50" fill="currentColor" style="width:16px"><use xlink:href="/img/icon/icon-set.svg#icon-cross"></use></svg>
                    </button>
                </div>

                <div data-scrollbar="" class="col mCustomScrollbar _mCS_2 mCS_no_scrollbar"><div id="mCSB_2" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" tabindex="0" style="max-height: none;"><div id="mCSB_2_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                    <div id="messengerContactsList" class="messenger-contacts-list">
            ...
            <div class="col d-flex flex-column">
                <div id="messengerBody" data-loader="spinner" data-scrollbar="" class="col my-2 messenger-body mCustomScrollbar _mCS_3 mCS_no_scrollbar"><div id="mCSB_3" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" tabindex="0" style="max-height: none;"><div id="mCSB_3_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                    <div id="messengerList" class="col d-flex flex-column mx-3 messenger-list">
                        <div id="messengerGreeting" class="col d-flex align-items-center justify-content-center text-center messenger-start-text">Приветствуем! Что бы ответить на сообщение виберите интересующий Вас контакт!</div>
                ...
                <form data-loader="" id="messengerForm" action="https://tparf.ru/admin/messages#" class="d-flex align-items-center border-top p-3 messenger-footer">
                    <textarea id="messengerField" name="message" class="col form-control border-0 p-0 mr-2 messenger-field" placeholder="Введите сообщение"></textarea>
                    <button type="submit" class="btn btn-dark p-0 messenger-send-btn">
                        <svg class="icon" viewBox="0 0 50 50" fill="currentColor" style="width:16px"><use xlink:href="/img/icon/icon-set.svg#icon-send-fill"></use></svg>
                    </button>

                    <button data-contacts-btn="" type="button" class="d-md-none btn btn-outline-secondary shadow-none p-0 ml-2 ml-sm-3">
                        <svg class="icon" viewBox="0 0 50 50" fill="currentColor" style="width:20px"><use xlink:href="/img/icon/icon-set.svg#icon-user-menu"></use></svg>
                    </button>
                </form>
            </div>

            <div id="messengerTmp" class="d-none">
                
    <div data-ms-contact="" data-contact-id="default" data-ms-id="default" class="d-flex pr-3 pl-2 py-2 border-bottom messenger-contact">
        <div class="d-flex rounded-circle mr-2 messenger-contact-avatar">
            <svg class="m-auto icon" viewBox="0 0 50 50"><use xlink:href="/img/icon/icon-set.svg#icon-ms-user"></use></svg>
        </div>
        <div class="messenger-contact-body">
            <div class="d-flex">
                <div data-ms-name="" class="col font-weight-bold pr-2 messenger-contact-name">Новое сообщение</div>
                <div data-ms-date="" class="font-weight-bold messenger-contact-date"></div>
            </div>
            <div data-ms-text="" class="text-nowrap overflow-hidden messenger-contact-text"></div>
        </div>
    </div>
    ...
    <script src="./messages_files/admin.min.js"></script>
