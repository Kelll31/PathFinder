  ...
  <section class="ftco-section">
    <div class="container">
      <div class="text mt-3 text-center">
                ...
                echo '<form method="POST" >
                  <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <h4 class="heading"><a href=productinfo.php?id=' . $cart[$i] . '>Проект : ' . $row['product_name'] . '  </a></h4>
											</div>
										</div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group text-center">
                        <h4 class="heading"><input name="delete' . $i . '" class="btn btn-primary text-center" type="submit" value="Отказаться" style="padding: 10px;position: absolute;"></h4>
                      </div>
                    </div>
        ...
        <h1 class="mb-0 bread text-center">Личные проекты</h1>
        <?php
