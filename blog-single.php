...
<head>
  <title>Торгово - промышленное агентство.</title>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="container pt-5">
    <div class="row justify-content-between">
      <div class="col">
        <a class="navbar-brand" href="index.php">Торгово - промышленное<span> Агентство. </span></a>
      </div>
        ...
        <div class="col-md-6 pl-md-5">
          <div class="row justify-content-start py-5">
            <div class="col-md-12 heading-section ftco-animate pl-md-4 py-md-4">
              <span class="subheading">Welcome to Главная Builder</span>
              ...
              <div class="tabulation-2 mt-4">
                <ul class="nav nav-pills nav-fill d-md-flex d-block">
                  <li class="nav-item mb-md-0 mb-2">
                    <a class="nav-link active py-2" data-toggle="tab" href="#Главная1">Our
                      Mission</a>
                  </li>
                  <li class="nav-item px-lg-2 mb-md-0 mb-2">
                    <a class="nav-link py-2" data-toggle="tab" href="#Главная2">Our Vision</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link py-2 mb-md-0 mb-2" data-toggle="tab" href="#Главная3">Our
                      Value</a>
                  </li>
                </ul>
                <div class="tab-content bg-light rounded mt-2">
                  <div class="tab-pane container p-0 active" id="Главная1">
                    <p>Ну в общем они лучшие. Separated they live in Bookmarksgrove right at the
                      coast of the Semantics, a large language ocean. Separated they live in
                      Bookmarksgrove right at the coast of the Semantics, a large language ocean.
                    </p>
                  </div>
                  <div class="tab-pane container p-0 fade" id="Главная2">
                    <p>Ну в общем они лучшие. Separated they live in Bookmarksgrove right at the
                      coast of the Semantics, a large language ocean. Separated they live in
                      Bookmarksgrove right at the coast of the Semantics, a large language ocean.
                    </p>
                  </div>
                  <div class="tab-pane container p-0 fade" id="Главная3">
                    <p>Ну в общем они лучшие. Separated they live in Bookmarksgrove right at the
                      coast of the Semantics, a large language ocean. Separated they live in
                      Bookmarksgrove right at the coast of the Semantics, a large language ocean.
                    </p>
  ...
  <section class="ftco-section">
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <h5 class="font-weight-bold">Главная Builder</h5>
          <p>Ну в общем они лучшие. Separated they live in Bookmarksgrove right at the coast of the Semantics,
  ...
  <div class="col-md-4 ftco-animate">
    <div class="work img d-flex align-items-end" style="background-image: url(images/berger.jpg);">
      <a href="images/berger.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
        <span class="icon-expand"></span>
      </a>
      <div class="desc w-100 px-4">
        <div class="text w-100 mb-3">
          <span>Ручной инструмент BERGER</span>
          <h2><a href="work-single.php">Перейти к категории</a></h2>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="col-md-4 ftco-animate ">
    <div class="work img d-flex align-items-end " style="background-image: url(images/ebmpapst.jpg);">
      <a href="images/ebmpapst.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
        <span class="icon-expand"></span>
      </a>
      <div class="desc w-100 px-4">
        <div class="text w-100 mb-3">
          <span>Вентиляторы ebm-papst</span>
          <h2><a href="work-single.php">Перейти к категории</a></h2>
        </div>
      </div>
    </div>
  ...
  <section class="hero-wrap hero-wrap-2" style="background-image: url('images/logo.jpg');"
    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-end">
        <div class="col-md-9 ftco-animate pb-5">
          <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Главная <i
                  class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="cart.php">Blog <i
        ...
        <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
          ...
          <div class="sidebar-box ftco-animate">
            <div class="categories">
              <h3>Categories</h3>
              <li><a href="#">Короткое описание <span class="ion-ios-arrow-forward"></span></a></li>
              <li><a href="#">Короткое описание <span class="ion-ios-arrow-forward"></span></a></li>
              <li><a href="#">Короткое описание <span class="ion-ios-arrow-forward"></span></a></li>
              <li><a href="#">Короткое описание <span class="ion-ios-arrow-forward"></span></a></li>
          ...
          <div class="sidebar-box ftco-animate">
            <h3>Tag Cloud</h3>
            <div class="tagcloud">
              <a href="#" class="tag-cloud-link">Главная</a>
