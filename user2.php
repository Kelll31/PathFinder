          ...
          if (isset($_POST['submitt'])) {
            ...
            if ($yesuser > 0) {
              ...
              if (filter_var($useremail, FILTER_VALIDATE_EMAIL)) {
                if ($pass1 == $pass2) {
                  mysqli_query($link, "INSERT INTO `users`(`user_login`, `user_password`, `user_name`, `user_hash`, `user_mail`,`user_phone`) VALUES ('$userlogin','$pass1','$username', '$hashh','$useremail','$userphone')");
                } else {
