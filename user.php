...
if (mysqli_query($link, "SELECT `user_id` FROM `users` WHERE `user_hash` LIKE '$hashh'")->fetch_array() != 0) {
  header('Location: http://localhost/tparf/lk.php');
  header('refresh: 0');
} else {
}
      ...
      <div class="text-center heading-section heading-section-white ftco-animate">
        <div class=" py-5 py-md-5 py-4 pl-lg-5 ">
          ...
          <form method="POST" class="contact-form">
            ...
            <div class="form-group">
              <input name="submitt" class=" col-md-12 btn btn-primary form-control submit px-3 nav-item" type="submit" value="Войти">
            </div>
          </form>
        </div>
      </div>
        ...
        <div class="col-md-9 py-5">
          ...
          <div class="row mt-md-5">
            <div class="col-md-12">
              <p class="copyright">
                Copyright &copy;
                <script>document.write(new Date().getFullYear());</script> Все права зарезервированны | Торгово - промышленное Агентство.</a>
              </p>
            </div>
          </div>
        </div>
