		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav mr-auto topmenu">
					...
					<li class="nav-item active"><a href="team.php" class="nav-link">Мои 11</a></li>
			...
			<div class="row no-gutters slider-text align-items-end">
				<div class="col-md-9 ftco-animate pb-5">
					<p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Главная <i
									class="ion-ios-arrow-forward"></i></a></span> <span>Мои 11 <i
								class="ion-ios-arrow-forward"></i></span></p>
					<h1 class="mb-0 bread">Мои 11</h1>
				</div>
			</div>
		</div>
	</section>
					...
					<div class="block-2 ftco-animate">
						<div class="flipper">
							...
							<div class="back">
								...
								<blockquote>
									<p>&ldquo;Краткая биография что бы было &rdquo;</p>
								</blockquote>
								<div class="author d-flex">
									<div class="image align-self-center">
										<img src="images/team-6.jpg" alt="">
									</div>
									<div class="name align-self-center ml-3">Вячеслав Середкин<span
											class="position">Ген.
											Директор</span></div>
								</div>
							</div>
						...
						<div class="flipper">
							...
							<div class="back">
								...
								<div class="author d-flex">
									...
									<div class="name align-self-center ml-3">Александр Наливайко<span
											class="position">Инженер</span></div>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="flipper">
							...
							<div class="back">
								...
								<div class="author d-flex">
									...
									<div class="name align-self-center ml-3">Анастасия Губина <span
											class="position">Ассистент</span></div>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="flipper">
							...
							<div class="back">
								...
								<div class="author d-flex">
									...
									<div class="name align-self-center ml-3">Андрей Мосеев <span
											class="position">Инженер-программист</span></div>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="flipper">
							...
							<div class="back">
								...
								<div class="author d-flex">
									...
									<div class="name align-self-center ml-3">Максим Филлипов
										<span class="position">Специалист по продажам</span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="flipper">
							...
							<div class="back">
								...
								<div class="author d-flex">
									...
									<div class="name align-self-center ml-3">Константин Черников<span
											class="position">Консультант</span></div>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="flipper">
							...
							<div class="back">
								...
								<div class="author d-flex">
									...
									<div class="name align-self-center ml-3">Станислав Стариков<span
											class="position">Писатель</span></div>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="flipper">
							...
							<div class="back">
								...
								<div class="author d-flex">
									...
									<div class="name align-self-center ml-3">Филлип Рубакин <span
											class="position">Бухгалтер</span></div>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					...
					<p>Здесь можно вставить длинный красивый текст</p>
					<p>И здесь тоже можно вставить длинный красивый текст</p>
				</div>
				<div class="col-md-4">
					<p>А вот тут красивую мысль </p>
				</div>
			</div>
		</div>
	</section>
